        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/auth/signup" className="hover:text-[#E8EDE6] transition-colors">소상공인 시작하기</Link></li>
              <li><Link href="/auth/signup" className="hover:text-[#E8EDE6] transition-colors">대학생 시작하기</Link></li>
